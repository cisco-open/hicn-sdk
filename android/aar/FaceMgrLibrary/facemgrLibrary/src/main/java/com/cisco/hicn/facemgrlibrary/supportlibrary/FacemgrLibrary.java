...
import com.cisco.hicn.facemgrlibrary.BuildConfig;
...
public class FacemgrLibrary {
    ...
    public static native String getFaceMgrVersion();

    public native void setLogLevel(int facemgrLogLevel);

    public static native void onNetworkEvent(String interface_name, int netdevice_type, boolean up, int family, String ip_address);

    public static void setContext(Context applicationContext) {
        FacemgrUtility.setContext(applicationContext);
    }

    public static String getFaceMgrAarVersion() {
