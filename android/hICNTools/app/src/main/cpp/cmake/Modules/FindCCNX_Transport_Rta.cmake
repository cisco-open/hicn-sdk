...
find_path(CCNX_TRANSPORT_RTA_INCLUDE_DIR ccnx/hicn/transport/librta_About.h
  HINTS ${CCNX_TRANSPORT_RTA_SEARCH_PATH_LIST}
  PATH_SUFFIXES include
  DOC "Find the Libccnx-transport-rta includes" )
	  
find_library(CCNX_TRANSPORT_RTA_LIBRARY NAMES ccnx_hicn_transport_rta
  HINTS ${CCNX_TRANSPORT_RTA_SEARCH_PATH_LIST}
  PATH_SUFFIXES lib
  DOC "Find the Libccnx-transport-rta libraries" )

find_library(CCNX_API_NOTIFY_LIBRARY NAMES ccnx_hicn_api_notify
  HINTS ${CCNX_TRANSPORT_RTA_SEARCH_PATH_LIST}
  PATH_SUFFIXES lib
  DOC "Find the Libccnx-transport-rta libraries" )

find_library(CCNX_API_CONTROL_LIBRARY NAMES ccnx_hicn_api_control
  HINTS ${CCNX_TRANSPORT_RTA_SEARCH_PATH_LIST}
  PATH_SUFFIXES lib
  DOC "Find the Libccnx-transport-rta libraries" )
